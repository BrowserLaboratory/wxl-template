...
- [x] 3.4 透過 **Decision: Per-stage commit checkpoint pattern using /tw-emoji-commit** 落地 Stage 3 commit，訊息開頭為 `🗑️ refactor:`。**驗收**：`git log --oneline -1` 顯示新 commit；訊息以 `🗑️ refactor:` 開頭；diff 同時涵蓋三組 file rename 與 SKILL.md 更新。
